...
# print('\n=== Random Forest ===')
# print(f'  train_size={len(train_df)}  RMSE=${rmse:,.0f}  MAE=${mae:,.0f}  MAPE={mape:.2f}%  R\u00b2={r2:.3f}')

# print('\n=== Baseline (Linear Regression) vs Random Forest ===')
# print(f'  Linear Regression R\u00b2: {baseline_r2:.3f}')
# print(f'  Random Forest     R\u00b2: {r2:.3f}')

# # -------------------------------------------------------------------
# # STEP 6 (optional but useful): Feature importance from the Random Forest
# # -------------------------------------------------------------------
